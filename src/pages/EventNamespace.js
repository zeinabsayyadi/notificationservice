...
import {
  owner_dashboard_get_namespace_event_active,
  owner_dashboard_get_namespace_event_all,
  owner_dashboard_get_namespace_event_deactive,
} from "../api/owner";
...
const EventNamespace = () => {
  ...
  useEffect(() => {
    axios({
      method: "GET",
      url: `${owner_dashboard_get_namespace_event_all}?page=${page}&limit=${rowsPerPage}`,
      headers: {
  ...
  const getDeactiveNamespaces = () => {
    axios({
      method: "GET",
      url: `${owner_dashboard_get_namespace_event_deactive}?page=${page}&limit=${rowsPerPage}`,
      headers: {
        "x-access-token": token,
        "Content-Type": "application/json",
      },
  ...
  const getActiveNamespaces = () => {
    axios({
      method: "GET",
      url: `${owner_dashboard_get_namespace_event_active}?page=${page}&limit=${rowsPerPage}`,
      headers: {
        "x-access-token": token,
        "Content-Type": "application/json",
      },
